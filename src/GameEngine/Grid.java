...
public class Grid extends JComponent implements KeyListener, MouseListener
{
  ...
  {
	  if (e.getKeyCode() == 32) spacebarDown = true;
	  else lastKeyPressed = e.getKeyCode();
  }
  
  public void keyReleased(KeyEvent e)
  {
	  if (e.getKeyCode() == 32) spacebarDown = false;
  }
  ...
  {
	  g.drawString("Next Wave in ..", 100, 100);
    for (int row = 0; row < getNumRows(); row++)
    {
      for (int col = 0; col < getNumCols(); col++)
      {
